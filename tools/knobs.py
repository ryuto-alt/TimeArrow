...
K = {
    ...
    "s4": dict(limit=43.0, rw=3, slamA=2.6, lockOpen=25.0, closeB=17.5,
    ...
    "s6": dict(limit=74.0, rw=3, slamA=2.8, boom1=24.0, closeC=12.0,
               boom2=40.0, closeE=20.0, lockZ=55.0),

    # S7「時計塔大回廊」ボタン+2リズムの刃+ツタ+最上層
    "s7": dict(limit=100.0, rw=4, slamA=2.3, lockD=30.0, sawP1=4.0, sawP2=3.0,
               vineGrow=40.0, sawP3=5.0, lockZ=68.0),

    # S8「時計職人の卒業試験・大」4フェーズ総合
    "s8": dict(limit=96.0, rw=5, slamA=2.6, boomB=26.0, closeC=13.0, slamD=10.5,
