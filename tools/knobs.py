...
K = {
    ...
    "s2": dict(limit=16.5, rw=3, closeA=2.8, closeB=8.5, closeC=14.0, closeD=15.5),
    ...
    "s4": dict(limit=41.0, rw=3, slamA=2.6, lockOpen=25.0, closeB=17.5,
               cwStart=5.0, cwSpeed=1.0, cwTravel=15.0, closeZ=32.0),

    # S5「時の昇降機・改」リフト+大玉チェイス+ツタ+フェリー+最上層
    "s5": dict(limit=64.0, rw=4, lift=14.0, slamG=2.6, ballRoll=4.0, ballSpeed=0.6,
               lockD=30.0, vineGrow=33.0, ferryP=6.0, closeY=44.0, lockZ=52.0),

    # S6「二本の導火線」地上とレッジの爆弾×2
    "s6": dict(limit=70.0, rw=3, slamA=2.8, boom1=24.0, closeC=12.0,
               boom2=40.0, closeE=20.0, lockZ=55.0),

    # S7「時計塔大回廊」ボタン+2リズムの刃+ツタ+最上層
    "s7": dict(limit=95.0, rw=4, slamA=2.3, lockD=30.0, sawP1=4.0, sawP2=3.0,
               vineGrow=40.0, sawP3=5.0, lockZ=68.0),

    # S8「時計職人の卒業試験・大」4フェーズ総合
    "s8": dict(limit=91.5, rw=5, slamA=2.6, boomB=26.0, closeC=13.0, slamD=10.5,
